    ...
    <div class="panel">
        ...
        <form action="{{ route('proyectos.actualizar', $proyecto['id']) }}" method="POST">
            ...
            <div class="campo">
                ...
                <input type="date" id="fechaInicio" name="fechaInicio" value="{{ old('fechaInicio', $proyecto['fechaInicio']) }}" required>
            </div>
            ...
            <div class="campo">
                ...
                <input type="number" id="monto" name="monto" step="1" min="0" value="{{ old('monto', $proyecto['monto']) }}" required>
            </div>

            <div class="acciones">
                <button type="submit" class="boton boton-primario">Actualizar proyecto</button>
